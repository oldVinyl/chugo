  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onloadend = () => {
      setQuickEditItem((prev) =>
        prev ? { ...prev, previewImage: reader.result as string } : prev,
      );
    };
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="relative bg-white p-4 rounded-xl w-full max-w-sm flex flex-col items-center gap-2">
              ...
              <div className="mt-2 flex flex-col items-center justify-center gap-2">
                <label className="block">Order Number Availiable?</label>
                  ...
                  <button
                    ...
                    onClick={() =>
                      setPromoQuantity((prev) =>
                        Math.min(
                          prev + 1,
                          selectedItem?.quantityAvailiable ?? prev + 1,
                        ),
                      )
                    }
                  >
              ...
              <div className="mt-2 flex flex-col items-center justify-center gap-2">
                ...
                <div className="relative flex border items-center justify-center rounded-xl px-2 py-4 gap-3 w-40">
                  <div className="flex gap-1">
                    ...
                    />
                    <p className="inline text-gray-500 text-xl">hrs</p>
                  </div>
                  ...
                  <div className="flex gap-1">
                    ...
                    />
                    <p className="inline text-gray-500 text-xl">mins</p>
                  </div>
                </div>
              </div>
              <button
