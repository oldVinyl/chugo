  ...
  return (
    <div className="h-full w-full">
      <div className="w-full h-full flex gap-3">
        <div className="w-2/3 h-[85vh] bg-white rounded-3xl p-6 overflow-y-auto no-scrollbar">
          <h2 className="text-xl font-semibold mb-4">Upload New Food Item</h2>
        ...
        <div className="relative w-1/3 h-[85vh] bg-white rounded-3xl p-4 flex flex-col gap-2 overflow-auto no-scrollbar">
